...
# this is too aggressive -> change later
...
num_fresh_populations = 50
total_num_sink_states = 0
std_dev_list = []
for q in range(num_fresh_populations):
...
# print(population[0].fitness_score)
# print()
# print("Number of sink states:", population[0].get_num_sink_states())
